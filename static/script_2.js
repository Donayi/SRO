document.addEventListener("DOMContentLoaded", () => {
    ...
    const TotClear = document.getElementById("clearTotal")
    ...
    async function saveSelection() {
        ...
        try {
            ...
            await fetch(`${API_URL}/clear2/${selectedCategory}`, { method: "DELETE" });
    
            // Luego guardamos todas las nuevas selecciones en una sola petición
            const response = await fetch(`${API_URL}/save2/`, {
                method: "POST",
    ...
    async function loadSelections() {
        ...
        const response = await fetch(`${API_URL}/selections2/${selectedCategory}`);
    ...
    async function clearSelectionsTot() {
        ...
        output.innerHTML = "Eliminando...";
        await fetch(`${API_URL}/cleartot2/${selectedCategory}`, { method: "DELETE" });
    ...
    TotClear.addEventListener("click", clearSelectionsTot);
